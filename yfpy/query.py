...
class YahooFantasySportsQuery(object):
    ...
    def __init__(self,
                 ...
                 env_file_location: Optional[Path] = Path(__file__).parent.parent,
        ...
        Args:
            ...
            env_file_location (:obj:`Path`, optional): Path to directory where .env file is located (defaults to project
                root directory).
        ...
        # load .env file in order to read local environment variables if env_var_fallback is True
        if self._env_var_fallback:
            load_dotenv(env_file_location / ".env")
