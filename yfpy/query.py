...
class YahooFantasySportsQuery(object):
    ...
    def get_all_available_players_by_pos(self, player_count_limit: int = None, position: str = 'C', player_count_start: int = 0,
                           is_retry: bool = False) -> List[Player]:
        ...
        while not all_players_retrieved:
            ...
            try:
                league_player_query_data = self.query(
                    f"https://fantasysports.yahooapis.com/fantasy/v2/league/{self.get_league_key()}/players;"
                    f"start={league_player_count};count={league_player_retrieval_limit if not is_retry else 1};position={position};status=A;sort=OR",
                    ["league", "players"]
                )
