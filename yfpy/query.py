...
class YahooFantasySportsQuery(object):
    ...
    def __init__(self, auth_dir: Union[Path, str], league_id: str, game_id: int = None, game_code: str = "nfl",
        ...
        Args:
            ...
            game_id (int, optional): Game ID of selected Yahoo fantasy game corresponding to a specific year, and
                defaulting to the current year.
            game_code (str, optional): Game code of selected Yahoo Fantasy game corresponding to a specific year, and
                defaulting to "nfl" (fantasy football), "nhl" (fantasy hockey), "mlb" (fantasy baseball), or "nba"
                (fantasy basketball)
            offline (bool, optional): Boolean to run in offline mode (Only works if all needed Yahoo Fantasy data has
                been previously saved locally using the Data module in data.py).
            all_output_as_json (bool, optional): Option to automatically convert all query output to JSON strings.
            consumer_key (str, optional): User defined consumer key to use instead of values stored in the private.json
                file (must be defined alongside a user defined consumer secret).
            consumer_secret (str, optional): User defined consumer secret to use instead of values stored in the
                private.json file (must be defined alongside a user defined consumer key).
            browser_callback (bool, optional): Enable or disable (enabled by default) whether the yahoo-oauth library
        ...
        Attributes:
            ...
            executed_queries (list of dict of str: Any): List of completed queries and their responses.
    ...
    def get_response(self, url: str, retries: int = 3, backoff: int = 0) -> Response:
        ...
        Args:
            ...
            backoff (int, optional): Multiplier that incrementally increases the wait time before retrying a failed
                query request.
    ...
    def query(self, url: str, data_key_list: Union[List[str], List[List[str]]], data_type_class: Type = None) -> (
        ...
        Args:
            url (str): REST API request URL string.
            data_key_list (list of str | list of list of str): List of keys used to extract the specific data desired
                by the given query (supports strings and lists of strings). Usage is as follows:
        ...
        Returns:
            Model class instance from yfpy/models.py, dictionary, or list (depending on query), with unpacked and parsed
                response data.
    ...
    def get_all_yahoo_fantasy_game_keys(self) -> List[Game]:
        ...
        Returns:
            list: List of YFPY Game instances.
    ...
    def get_game_weeks_by_game_id(self, game_id: int) -> List[GameWeek]:
        ...
        Returns:
            list: List of YFPY GameWeek instances.
    ...
    def get_game_position_types_by_game_id(self, game_id: int) -> List[PositionType]:
        ...
        Returns:
            list: List of YFPY PositionType instances.
    ...
    def get_game_roster_positions_by_game_id(self, game_id: int) -> List[RosterPosition]:
        ...
        Returns:
            list: List of YFPY RosterPosition instances.
    ...
    def get_user_leagues_by_game_key(self, game_key: int) -> List[League]:
        ...
        Returns:
            list: List of YFPY League instances.
    ...
    def get_user_teams(self) -> List[Game]:
        ...
        Returns:
            list: List of YFPY Game instances with "teams" field containing list of YFPY Team instances.
    ...
    def get_league_teams(self) -> List[Team]:
        ...
        Returns:
            list: List of YFPY Team instances.
    ...
    def get_league_players(self, player_count_limit: int = None, player_count_start: int = 0,
        ...
        Returns:
            list: List of YFPY Player instances.
    ...
    def get_league_draft_results(self) -> List[DraftResult]:
        ...
        Returns:
            list: List of YFPY DraftResult instances.
    ...
    def get_league_transactions(self) -> List[Transaction]:
        ...
        Returns:
            list: List of YFPY Transaction instances.
    ...
    def get_league_matchups_by_week(self, chosen_week: int) -> List[Matchup]:
        ...
        Returns:
            list: List of YFPY Matchup instances.
    ...
    def get_team_info(self, team_id: str) -> Team:
        ...
        Args:
            team_id (type): Selected team ID for which to retrieva data (can be integers 1 through n where n is the
    ...
    def get_team_stats_by_week(self, team_id: str, chosen_week: Union[int, str] = "current") -> (
        ...
        Returns:
            dict: Dictionary containing both a YFPY TeamPoints instance and a YFPY TeamProjectedPoints instance with
    ...
    def get_team_roster_player_info_by_week(self, team_id: str,
        ...
        Returns:
            list: List of YFPY Player instances containing the keys "draft_analysis", "ownership", "percent_owned", and
                "player_stats", which each return instances of their respective YFPY objects.
    ...
    def get_team_roster_player_info_by_date(self, team_id: str, chosen_date: str = None) -> List[Player]:
        ...
        Note: This applies to MLB, NBA, and NHL leagues, but does NOT apply to NFL leagues.

        Warning: This query will FAIL if you pass it an INVALID date string!
    ...
    def get_team_roster_player_stats_by_week(self, team_id: str,
        ...
        Returns:
            list: List of YFPY Player instances containing the "player_stats" key (returns a YFPY PlayerStats instance).
